...
export class ReputationClient {
  ...
  async signFeedbackAuth(auth: FeedbackAuth): Promise<string> {
    // Encode the feedbackAuth tuple (domain-separated payload)
